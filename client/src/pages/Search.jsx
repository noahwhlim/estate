  ...
  const handleChange = (e) => {
    ...
    if (
      ...
      setSidebarData({
        ...sidebarData,
        [e.target.id]:
          e.target.checked || e.target.checked === "true" ? true : false, // if e.target.checked is a string, convert it to boolean
      });
    }
    ...
    <div className="flex flex-col md:flex-row">
      ...
      <div className="flex-1">
        ...
        <div className="p-7 flex flex-wrap gap-4">
          ...
          {loading && (
            <p className="text-stone-700 text-xl text-center w-full">
              Loading...
            </p>
          )}
